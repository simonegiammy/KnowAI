  ...
  Widget build(BuildContext context) {
    ...
    buildChat() {
      return Container(
        ...
        margin: const EdgeInsets.only(left: 0, top: 12, bottom: 12),
    ...
    return Scaffold(
      floatingActionButton:
          (isScrolled && (MediaQuery.of(context).size.width <= 500)) &&
                  !showingChat
              ? AppFab(
                  onTap: () {
            ...
            children: [
              ...
              if (MediaQuery.of(context).size.width < 500)
                Align(
                  ...
                  child: Padding(
                      padding: const EdgeInsets.fromLTRB(16, 0, 20, 80),
                      child: GestureDetector(
                        onTap: () {
                          setState(() {
                            showingChat = true;
              ...
              if (showingChat)
                Container(color: AppStyle.black, child: buildChat()),
            ],
          )),
    );
  }
